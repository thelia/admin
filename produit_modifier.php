...
?>  
                            ...
                            <div class="tab-pane <?php if ($tab == 'imageTab') echo "active"; ?>" id="imageTab">
                                ...
                                <div class="row-fluid">
                                    ...
                                    <div class="span1">
                                        <a class="change-page" href="produit_modifier.php?ref=<?php echo $produit->ref; ?>&action=modifyAttachementPosition&direction=M&attachement=image&attachement_id=<?php echo $image['id']; ?>&lang=<?php echo $lang; ?>&tab=imageTab">
                                            <i class="icon-arrow-up"></i>
                                        </a>
                                        
                                        <a class="change-page" href="produit_modifier.php?ref=<?php echo $produit->ref; ?>&action=modifyAttachementPosition&direction=D&attachement=image&attachement_id=<?php echo $image['id']; ?>&lang=<?php echo $lang; ?>&tab=imageTab">
...
$(document).ready(function(){
    ...
    $(".js-delete-picture").click(function(){
        ...
        $("#pictureDelationLink").attr("href","produit_modifier.php?ref=<?php echo $produit->ref ?>&action=deleteAttachement&attachement=image&attachement_id="+$(this).attr('picture-id')+"&lang=<?php echo $lang; ?>&tab=imageTab");
    });
    
    $(".js-delete-document").click(function(){
        $("#documentFileName").html($(this).attr('document-file'));
        $("#documentDelationLink").attr("href","produit_modifier.php?ref=<?php echo $produit->ref ?>&action=deleteAttachement&attachement=document&attachement_id="+$(this).attr('document-id')+"&lang=<?php echo $lang; ?>&tab=documentTab");
    });
